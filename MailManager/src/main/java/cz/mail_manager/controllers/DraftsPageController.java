...
public class DraftsPageController {
	...
	public String submit(Model model) {
		...
		List<Email> emails = receivedEmails.getEmailsHeader("drafts", 0);
	...
	public @ResponseBody Email getEmailContent (Model model, int detailIndex) {
		...
		Email email = receivedEmails.getEmailDetail("drafts", detailIndex);
	...
	public @ResponseBody List<Email> getMoreEmails(int lastIndex) {
		...
		List<Email> emails = receivedEmails.getEmailsHeader("drafts", lastIndex);
	...
	public @ResponseBody List<Email> refresh(String sentDate) {
		...
		List<Email> emails = receivedEmails.refreshEmailsHeader("drafts", sentDate);
