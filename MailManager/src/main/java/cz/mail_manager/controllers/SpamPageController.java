...
public class SpamPageController {
	...
	public String submit(Model model) {
		...
		List<Email> emails = receivedEmails.getEmailsHeader("spam", 0);
	...
	public @ResponseBody Email getEmailContent (Model model, int detailIndex) {
		...
		Email email = receivedEmails.getEmailDetail("spam", detailIndex);
	...
	public @ResponseBody List<Email> getMoreEmails(int lastIndex) {
		...
		List<Email> emails = receivedEmails.getEmailsHeader("spam", lastIndex);
	...
	public @ResponseBody List<Email> refresh(String sentDate) {
		...
		List<Email> emails = receivedEmails.refreshEmailsHeader("spam", sentDate);
