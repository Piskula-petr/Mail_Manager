...
public class NewslettersPageController {
	...
	public String submit(Model model) {
		...
		List<Email> emails = receivedEmails.getEmailsHeader("newsletters", 0);
	...
	public @ResponseBody Email getEmailContent (Model model, int detailIndex) {
		...
		Email email = receivedEmails.getEmailDetail("newsletters", detailIndex);
	...
	public @ResponseBody void moveEmail(int detailIndex, String folder) {
		...
		receivedEmails.move("newsletters", detailIndex, folder);
	}
	...
	public @ResponseBody void deleteEmail(int detailIndex) {
		...
		receivedEmails.delete("newsletters", detailIndex);
	}
	...
	public @ResponseBody List<Email> getMoreEmails(int lastIndex) {
		...
		List<Email> emails = receivedEmails.getEmailsHeader("newsletters", lastIndex);
	...
	public @ResponseBody List<Email> refresh(String sentDate) {
		...
		List<Email> emails = receivedEmails.refreshEmailsHeader("newsletters", sentDate);
